...
public class AlmacenamientoRestController {
	...
	public ResponseEntity<?> show(@PathVariable Long id) {
		...
		if (almacenamiento == null) {
			response.put("mensaje",
					"El almacenamiento ID:".concat(id.toString().concat(" no existe en la base de datos")));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
		}
		return new ResponseEntity<Almacenamiento>(almacenamiento, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> update(@Valid @RequestBody Almacenamiento almacenamiento, BindingResult result,
